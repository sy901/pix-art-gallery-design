...
const Hero = () => {
  return <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 right-32 w-24 h-24 rounded-full bg-pastel-pink/30 animate-float" style={{
        animationDelay: '2s'
      }}></div>
        <div className="absolute bottom-32 left-40 w-20 h-20 rounded-full bg-pastel-blue/25 animate-float" style={{
        animationDelay: '4s'
      }}></div>
        <div className="absolute bottom-20 right-20 w-28 h-28 rounded-full bg-pastel-green/20 animate-float" style={{
        animationDelay: '1s'
      }}></div>
      </div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed font-light tracking-wide animate-fade-in-up" style={{
          animationDelay: '0.2s'
        }}>Transform your events into masterpieces with our photobooth experience. Where cartoons meet gallery sophistication.</p>

          {/* CTA Button */}
          <div className="mb-16 animate-fade-in-up" style={{
          animationDelay: '0.4s'
        }}>
            <Button size="lg" className="gradient-primary text-lg font-semibold px-12 py-6 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 animate-glow hover-lift">
              Get Started!
            </Button>
          </div>

          {/* Photobooth UI Mockup */}
          <div className="relative max-w-4xl mx-auto animate-fade-in-up" style={{
          animationDelay: '0.6s'
        }}>
