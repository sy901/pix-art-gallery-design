  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-32 w-12 h-12 border-2 border-pastel-pink/20 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/2 left-10 w-8 h-8 border-2 border-pastel-blue/20 rounded-full animate-pulse" style={{animationDelay: '4s'}}></div>
      </div>
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="flex items-center justify-center space-x-6 mt-8">
            <Button
              ...
              className="glass rounded-full hover:scale-110 transition-all duration-300"
            >
              <ChevronLeft size={20} />
            </Button>
